...
export function IdentificationResultPanel({
  ...
  return (
    <div
      data-testid={isResolved ? 'identification-result-resolved' : 'identification-result-no-match'}
    ...
    >
      ...
      <div className="flex flex-col gap-2">
        <Button type="button" data-testid="btn-confirm-species" disabled={selectedIndex === null} onClick={onConfirm}>
          {dict.resolved.createPlantCta}
        </Button>
        <Button type="button" variant="outline" size="sm" data-testid="btn-none-match" onClick={onNoneMatch}>
          {dict.noneMatch}
        </Button>
      </div>
    </div>
