...
describe("SpaceSettingsScreen", () => {
  ...
  it("renders ScreenHeader with the settings title", () => {
    ...
    render(<SpaceSettingsScreen dict={dict} memberListDict={memberListDict} lang="en" />);
  ...
  it("shows loading skeleton when isLoading is true", () => {
    ...
    const { container } = render(<SpaceSettingsScreen dict={dict} memberListDict={memberListDict} lang="en" />);
