...
const dict = {
  ...
  detail: {
    ...
    plantsCount: 'plantas',
    position: 'Posición',
    waterSpot: 'Regar todo el bancal',
    waterSpotConfirmTitle: '¿Regar todas las plantas de este bancal?',
    waterSpotConfirmDescription: 'Se registrará un riego para cada planta de este bancal.',
    waterSpotConfirm: 'Regar',
    waterSpotCancel: 'Cancelar',
