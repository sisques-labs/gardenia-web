...
import type { NodesDict } from '@/core/nodes/presentation/i18n/en';
...
import enNodes from '@/core/nodes/presentation/i18n/en';
import esNodes from '@/core/nodes/presentation/i18n/es';
...
export type AppDict = {
  ...
  nodes: WidenStringLiterals<NodesDict>;
};
